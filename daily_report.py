...
import db
from utils import send_admin_log, send_backup_db

async def run_daily_report():
    async with aiosqlite.connect(db.DB_PATH, timeout=10.0) as conn:
    ...
    # Регулярный бэкап базы данных в канал бэкапов
    await send_backup_db(db.DB_PATH)
    print("Бэкап базы данных успешно отправлен в канал бэкапов.")
